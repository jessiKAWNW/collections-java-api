...
public class AgendaEventos {
    ...
    public void adicionarEvento(LocalDate data, String nome, String nomeAtracao){
...
//        Collections<Evento> values = eventoMap.values();
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2024, 9, 25), "Seminário de Inteligência Artificial", "Discussão sobre IA avançada");
